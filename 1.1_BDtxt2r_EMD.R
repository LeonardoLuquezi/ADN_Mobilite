# ================================================================================ #
#       Transformation de l'ED de Loire Atlantique au format .txt en .RDS
#                                       script                                      
...
#Paths pour lire données brutes .txt de l'Enquête
...
#Paths correspondance entre les donnés; ce qu'il y a dans chaque ligne de chaque BD
...
#Paths pour sauvegarder les données brutes .RDS de l'Enquête
